  ...
  input_schema: {
    ...
    properties: {
      ...
      objects: {
        ...
        items: { type: "string" },
        description: "Objects plainly visible in the frame. Empty if none stand out.",
      },
      clothing: {
        type: "array",
        maxItems: MAX_LIST_ITEMS,
        items: { type: "string" },
        description: "Clothing and accessories visible on people in frame.",
      },
      brands: {
        type: "array",
        maxItems: MAX_LIST_ITEMS,
        items: { type: "string" },
        description:
          "Brands or products you can actually read or unmistakably see. Empty if you are inferring.",
      },
      keywords: {
        type: "array",
...
export async function generateMetadataForAsset(input: {
  ...
  try {
    ...
    const generated = normaliseGeneration(call?.input, describeBasis(context));
