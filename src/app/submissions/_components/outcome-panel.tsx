...
import { type DispatchState, recordOutcomeAction } from "@/app/dispatch/actions";
import { type MoneyActionState, recordSaleAction } from "@/app/money/actions";
...
export function OutcomePanel({
  ...
  const [saleState, saleAction, salePending] = useActionState(recordSaleAction, SALE_INITIAL);
