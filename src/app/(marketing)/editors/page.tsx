    ...
    <>
      <section className="pagehead">
        <div className="wrap">
          ...
          <p className="lede">
            ...
            arrive captioned and cleared, exclusives hold, and the files release the moment a desk
            says yes.
          </p>
        </div>
      </section>
      ...
      <section className="spot">
        <div className="wrap" style={{ display: "block" }}>
          <div className="head" style={{ marginBottom: "0" }}>
            <div>
              <span className="mk-eyebrow">Optional, never required</span>
              <h2>A free editor account, for desks that buy often.</h2>
            </div>
            <div>
              <p className="lede">
                One inbox for every pitch a desk receives, a place to post briefs that go straight
                to photographers who can deliver, saved preferences, and a searchable record of
                every license held. Optional, free, and never required to buy.
              </p>
      ...
      <section>
        <div className="wrap">
          <div className="head">
            <div>
              <span className="mk-eyebrow">What arrives</span>
              <h2>Pictures with their paperwork already done.</h2>
            </div>
            <p className="lede">
              Every image that arrives through Mastline brings the things a desk usually has to
              chase.
            </p>
          </div>
          <div className="principles" data-rv-group>
            <div>
              ...
              <p>
                ...
                of where it has been. The frame is what came out of the camera, with standard tone
                and crop only; anything beyond that is flagged.
              </p>
            </div>
            <div>
              ...
              <p>
                ...
                terms accepted, kept on both sides. No reconstructing a deal from an email thread
                six months later.
              </p>
            </div>
            <div>
              ...
              <p>
                ...
                places are checked against the photographer’s own records before the pitch goes out.
              </p>
            </div>
            <div>
              <h3>Exclusives that mean something</h3>
              <p>
                When an exclusive is offered, the countdown is real: the set is not released to
                anyone else until the window ends. Once taken, no one else gets it for the agreed
                period.
              </p>
            </div>
            <div>
              <h3>Files on acceptance</h3>
              <p>
            ...
            <div>
              <h3>Invoices an accounts team recognizes</h3>
              <p>
                The invoice arrives in the format the outlet requires, with PO and reference fields,
                per deal or batched monthly.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="wrap">
          <div className="head">
            <div>
              ...
              <h2>One inbox for every photographer. One place to ask for a picture.</h2>
            </div>
            <p className="lede">
              Optional, free, and built for desks that buy often. Buying from a single link works
          ...
          <div className="principles" data-rv-group>
            <div>
              <h3>A pitch inbox</h3>
              <p>
                Every Mastline pitch sent to the desk, from every photographer, in one list sorted
            ...
            <div>
              <h3>Post a brief</h3>
              <p>
                Post what the desk is looking for: a subject, a venue, a date range, an archive
                year. Briefs go only to photographers who have the subject on file or are positioned
                to shoot it, and the responses come back as normal pitches.
              </p>
            </div>
            <div>
              <h3>Saved preferences</h3>
              <p>
                Rights bought, formats taken, subjects covered, desk hours, invoice format and PO
                rules. Photographers see them before pitching, so fewer pitches miss.
              </p>
            </div>
            <div>
              <h3>A license library</h3>
              <p>
                Every license the outlet holds through Mastline, searchable by subject,
            ...
            <div>
              ...
              <p>
                ...
                by name, so the record always shows who bought what.
              </p>
            </div>
            <div>
              <h3>Still nothing to pay</h3>
              <p>
                Editor accounts are free. Mastline earns from the photographer’s side of a sale,
                never from the desk.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <ul>
              ...
              <li>
                ...
                <span>
                  <b>Say what the desk wants.</b> Tell a photographer it prefers couples, arrivals,
                  or UK rights only, and future pitches reflect it.
                </span>
              </li>
              <li>
                <svg
                ...
                <span>
                  <b>Pay the usual way.</b> Card or bank through Stripe, or on the outlet’s standard
                  terms.
                </span>
              </li>
            </ul>
      ...
      <section>
        <div className="wrap">
          ...
          <div className="never" data-rv-group>
            ...
            <div>
              <span>
                <b>Desk information stays with the desk.</b> Contact details, preferences, and
                prices paid are visible only to the photographer on the other side of the deal.
                Mastline never sells or pools buyer data.
              </span>
            </div>
          </div>
          <p style={{ marginTop: "18px", fontSize: "14px", color: "var(--ink-3)" }}>
            Read more on the <Link href="/trust">Trust</Link> page, the{" "}
            <Link href="/acceptable-use">Acceptable use</Link> summary, or the{" "}
            <Link href="/privacy">Privacy Policy</Link>. A subject who contacts the desk about a
            Mastline image can be pointed to <Link href="/subjects">Appearing in a photo</Link>.
          </p>
        </div>
      </section>
          ...
          <div className="faq-grid">
            ...
            <div className="faq" data-rv-group>
              <details open>
                ...
                <p>
                  No. The link is the whole thing: view, counter, accept, and download without
                  creating an account. A free editor account adds an inbox, briefs, and a license
                  library, but it’s never required to buy.
                </p>
              </details>
              <details>
                <summary>Who am I buying from, the photographer or Mastline?</summary>
                <p>
                  The photographer. The license is between the outlet and them; Mastline generates
                  the paperwork, delivers the files, and keeps the record. The invoice comes from
                  the photographer, or from Mastline on their behalf where they have asked it to
                  collect.
                </p>
              </details>
              <details>
              ...
              <details>
                ...
                <p>
                  The set is released to other buyers at the non-exclusive price. It can still be
                  bought — just not exclusively.
                </p>
              </details>
              <details>
              ...
              <details>
                ...
                <p>
                  Yes. Forward the link to colleagues; it opens for anyone on the team. Only one
                  acceptance is recorded, and the photographer sees which address accepted.
                </p>
              </details>
              <details>
                <summary>How do I get my outlet’s invoice requirements into the system?</summary>
                <p>
                  Tell the photographer once, or email{" "}
                  <a href="mailto:hello@mastline.co">hello@mastline.co</a> with the format, PO
                  rules, and payment terms, and every Mastline photographer billing that desk will
                  use them.
                </p>
              </details>
              <details>
                ...
                <p>
                  Yes. Email <a href="mailto:hello@mastline.co">hello@mastline.co</a> with what the
                  desk is looking for, and it is routed to photographers who have that subject on
                  file or are in position to get it.
                </p>
              </details>
            </div>
          </div>
      ...
      <section className="cta-band">
        <div className="wrap">
          <div>
            <h2>Questions about a pitch that arrived?</h2>
            <p>Reply to the photographer directly from the link, or contact Mastline any time.</p>
          </div>
