...
export function DeliveryLinks({
  ...
  const [createState, createAction, creating] = useActionState(createDeliveryAction.bind(null, workspaceSlug), INITIAL);
  const [revokeState, revokeAction] = useActionState(revokeDeliveryAction.bind(null, workspaceSlug), INITIAL);
